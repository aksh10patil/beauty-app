...
const Checkout = ({ cart = [], setCart }) => {
  ...
  const handlePayment = async () => {
    ...
    try {
      // Create order
      const orderResponse = await axios.post(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/api/create-order`, {
        ...
        handler: async function (response) {
          try {
            ...
            const verifyResponse = await axios.post(
              `${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/api/verifyPayment`, {
              order_id: order_id,
